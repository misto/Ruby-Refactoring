...
public class OccurenceReplaceSelectionPage extends RefactoringWizardPage {
	...
	private void initCodeView(Composite control) {
		final CodeViewer viewer = RefactoringPlugin.getRefactoringObjectFactory().getCodeViewer(control);
		possibilityTable.addSelectionListener(new SelectionListener(){
			...
			private void updateCodeViewer(final CodeViewer viewer, ISourcePosition pos, String content) {
