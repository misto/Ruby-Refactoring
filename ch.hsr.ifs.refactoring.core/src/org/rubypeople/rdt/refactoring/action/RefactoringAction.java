...
public class RefactoringAction extends Action {
	...
	private ITextSelectionProvider selectionProvider;

	public RefactoringAction(Class<? extends RubyRefactoring> refactoringClass, String refactoringName, ITextSelectionProvider selectionProvider) {
