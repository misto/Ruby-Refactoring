...
public class WorkspaceDocumentProvider extends DocumentProvider {
	...
	public WorkspaceDocumentProvider(IFile activeFile) {
		if(activeFile != null) {
			...
			this.activeFileContent = getFileContent(activeFile);
		}
	}
	...
	public String getFileContent(IFile file) {
		try {
			return FileHelper.getReaderContent(new BufferedReader(new InputStreamReader(file.getContents())));
		} catch (CoreException e) {
			RefactoringPlugin.log(e);
			return "";
		}
	...
	public String getFileContent(String fileName) {
		return getFileContent(getIFile(fileName));
	}
}
