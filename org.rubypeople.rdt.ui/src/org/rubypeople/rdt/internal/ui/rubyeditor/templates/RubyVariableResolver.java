...
/**
 * Looks up existing ruby variables and proposes them. The proposals are sorted by 
 * their prefix-likeness with the variable type.
 */
public class RubyVariableResolver extends TemplateVariableResolver {
	/*
	...
	protected String[] resolveAll(TemplateContext context) {
		// FIXME Add meaningful proposals!
