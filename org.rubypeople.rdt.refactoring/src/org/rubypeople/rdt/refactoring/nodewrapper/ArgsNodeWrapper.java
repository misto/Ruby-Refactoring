...
public class ArgsNodeWrapper implements INodeWrapper {
	...
	public boolean hasArgs() {
		return argsNode.getArgs() != null && argsNode.getArgs().size() != 0 || argsNode.getOptArgs() != null || argsNode.getBlockArgNode() != null || argsNode.getRestArg() > 0;
	}
	...
	public boolean argsCountMatches(MethodCallNodeWrapper callNode) {
		...
		int minArgs = argsNode.getArgs() != null ? argsNode.getArgs().size() : 0;
