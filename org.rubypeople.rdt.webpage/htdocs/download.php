 <table bgcolor="#ffffff" border="0" cellpadding="2" cellspacing="5">
  <tr>
    ...
    <td valign="top"><font face="arial,helvetica,geneva" size="-1"><b> Using the Eclipse Update Manager</b>
      ...
      <ul>
        ...
        <li/>Select "Add Update Site", enter an arbitrary name and the url http://rubyeclipse.sf.net/updatesite
  ...
  <tr>
    ...
    <td valign="top"><font face="arial,helvetica,geneva" size="-1"><b> Download the zipped plugin</b>
      <br/>
      <p>The plugin releases are available at Sourceforge.net's <a href="http://sourceforge.net/project/showfiles.php?group_id=50233">RDT Files</a> section.<br/>
  ...
  <tr>
    <td align="right" valign="top" width="20"><img src="images/arrow.gif" alt="" border="0" height="16" width="16"></td>
    <td valign="top"><font face="arial,helvetica,geneva" size="-1"><b> Nightly build</b>
      <br/>
      <p>There is an automatic nightly build of the sources in CVS. Usually you do <b>not</b> want to use this. However, it might be useful if you 
		...
		quality of this build. It might not even fully compile. A hint of the quality of this build gives the 
		<a href="nightlyBuild/org.rubypeople.rdt.tests.all_.html">result of the (PDE) unit test suite</a>. A last warning: the nighly build runs on the sourceforge compile farm. Sourceforge advises
		to inform end users about the possibility of unauthorized changes to the build result.
	  <br/>
			<a href="nightlyBuild">Nightly Build Results</a>
     </p>
      </font>
    </td>
  </tr>   
