...
public class WorkQueue {
	...
	public void addAll(IResource[] elements) {
	...
	public void finished(IResource element) {
		needsCompileList.remove(element);
		compiledList.add(element);
	}

	public boolean isCompiled(IResource element) {
		return compiledList.contains(element);
	}

	public boolean isWaiting(IResource element) {
