...
public class RubyParsingStringTokenizer {
     ...
     *                         as tokens.
     */
    public RubyParsingStringTokenizer(String str, String delim, boolean returnDelims) {
	currentPosition = 0;
	newPosition = -1;
	delimsChanged = false;
	this.str = str;
     ...
     * @param   delim   the delimiters.
     */
    public RubyParsingStringTokenizer(String str, String delim) {
