 ...
 *  
 */
public class LowerCaseNameRule implements ParseRule {
	 ...
	 * @param token
	 */
	public LowerCaseNameRule(RubyElement token) {
		this.element = token;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.rubypeople.rdt.internal.core.parser.rules.ParseRule#isAllowed()
	 */
	...
	public ParseError getError() {
		String type = "Element";
		if (element.isType(RubyElement.METHOD)) {
			type = "Method";
		}
		return new ParseError(type + " names should begin with an lowercase letter.", element, ParseRule.WARNING);
	}
