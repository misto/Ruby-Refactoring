...
public class RubyParserStack {
	 ...
	 * @param element
	 */
	public void push(RubyElement element) {
	...
	/**
	 * Returns boolean flag to indicate if the stack has no open elements
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the last open RubyClass or RubyModule. If none are open, returns
	 * null.
	 * 
	 * @return
	 */
