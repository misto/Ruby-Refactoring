...
public class RubyParserTest extends TestCase {
	...
	public void testRecognizesSingleRequires() throws Exception {
		...
		RubyRequires requires = new RubyRequires("tk", 9, 11);
		assertEquals(requires, script.getRequires("tk"));
		assertEquals(9, script.getRequires("tk").getStart());
		assertEquals(11, script.getRequires("tk").getEnd());
		assertTrue(script.contains(requires));
		assertFalse(script.contains(new RubyRequires("fake", -987, 8796)));
		assertEquals(1, script.getElementCount());
	}

	public void testRecognizesTwoRequires() throws Exception {
		RubyScript script = RubyParser.parse("require \"tk\"\nrequire \"irb\"\n");
		assertTrue(script.contains(new RubyRequires("tk", 9, 11)));
		assertTrue(script.contains(new RubyRequires("irb", 21, 24)));
		assertFalse(script.contains(new RubyRequires("fake", -987, 86587)));
	...
	public void testRecognizesClass() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(1, script.getElementCount());
		assertFalse(script.contains(new RubyClass("Bob", 756578)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(9, script.getClass("Bob").getEnd());
	}
	...
	public void testRecognizesModule() throws Exception {
		...
		assertFalse(script.contains(new RubyModule("Bob", 756578)));
		assertEquals(7, script.getModule("Bob").getStart());
		assertEquals(10, script.getModule("Bob").getEnd());
	}

	public void testRecognizesScriptLevelMethod() throws Exception {
		RubyScript script = RubyParser.parse("def bob\nend\n");
		assertEquals(1, script.getElementCount());
		assertTrue(script.contains(new RubyMethod("bob", 4)));
		assertFalse(script.contains(new RubyMethod("bob", 756578)));
		assertEquals(4, script.getMethod("bob").getStart());
		assertEquals(7, script.getMethod("bob").getEnd());
	}
	...
	public void testRecognizesOneLineMethod() throws Exception {
		...
		assertFalse(script.contains(new RubyMethod("bob", 756578)));
		assertEquals(4, script.getMethod("bob").getStart());
		assertEquals(22, script.getMethod("bob").getEnd());
	}
	...
	public void testRecognizesMethodWithParameters() throws Exception {
		...
		assertFalse(script.contains(new RubyMethod("bob", 756578)));
		assertEquals(4, script.getMethod("bob").getStart());
		assertEquals(28, script.getMethod("bob").getEnd());
	}
	...
	public void testRecognizesClassInstanceMethod() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(19, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertTrue(bob.contains(new RubyMethod("bob", 13)));
		assertNotNull(bob.getElement("bob"));
		assertEquals(13, bob.getElement("bob").getStart());
		assertEquals(16, bob.getElement("bob").getEnd());
	}
	...
	public void testRecognizesClassVariable() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(26, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
	...
	public void testRecognizesIfBlock() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(63, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertTrue(bob.contains(new RubyMethod("initialize", 13)));
		assertEquals(13, bob.getElement("initialize").getStart());
		assertEquals(60, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(1, method.getElementCount());
		assertTrue(method.contains(new RubyIf(23)));
	}
	...
	public void testIgnoresIfModifier() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(48, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertTrue(bob.contains(new RubyMethod("initialize", 13)));
		assertEquals(13, bob.getElement("initialize").getStart());
		assertEquals(45, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
	...
	public void testRecognizesUnlessBlock() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(67, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertTrue(bob.contains(new RubyMethod("initialize", 13)));
		assertEquals(13, bob.getElement("initialize").getStart());
		assertEquals(64, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(1, method.getElementCount());
		assertTrue(method.contains(new RubyUnless(23)));
	}
	...
	public void testIgnoresUnlessModifier() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(47, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertTrue(bob.contains(new RubyMethod("initialize", 13)));
		assertEquals(13, bob.getElement("initialize").getStart());
		assertEquals(44, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(0, method.getElementCount());
	}
	...
	public void testRecognizesCaseBlock() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(72, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertTrue(bob.contains(new RubyMethod("initialize", 13)));
		assertEquals(13, bob.getElement("initialize").getStart());
		assertEquals(69, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(1, method.getElementCount());
		assertTrue(method.contains(new RubyCase(23)));
	}
	...
	public void testRecognizesUntilBlock() throws Exception {
		...
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(6, script.getClass("Bob").getStart());
		assertEquals(61, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertTrue(bob.contains(new RubyMethod("initialize", 13)));
		assertEquals(13, bob.getElement("initialize").getStart());
		assertEquals(58, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(1, method.getElementCount());
		assertTrue(method.contains(new RubyUntil(23)));
	}
	...
	public void testIgnoresUntilModifier() throws Exception {
		...
		assertEquals(1, script.getElementCount());
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(53, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertTrue(bob.contains(new RubyMethod("initialize", 13)));
		assertEquals(13, bob.getElement("initialize").getStart());
		assertEquals(50, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(0, method.getElementCount());
	}
	...
	public void testComplainsAboutLowercaseClassName() throws Exception {
		...
		assertEquals(13, bob.getElement("initialize").getStart());
		assertEquals(23, bob.getElement("initialize").getEnd());
	}
	...
	public void testRecognizesWhileBlock() throws Exception {
		...
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(1, method.getElementCount());
		assertTrue(method.contains(new RubyWhile(23)));
	}
	...
	public void testIgnoresWhileModifier() throws Exception {
		...
		assertEquals(1, script.getElementCount());
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(49, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(1, bob.getElementCount());
		assertEquals(46, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(0, method.getElementCount());
	}
	...
	public void testRecognizesForBlock() throws Exception {
		...
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(1, method.getElementCount());
		assertTrue(method.contains(new RubyFor(23)));
	}
	...
	public void testRecognizesBeginBlock() throws Exception {
		...
		assertEquals(1, script.getElementCount());
		assertTrue(script.contains(new RubyClass("Bob", 6)));
		assertEquals(42, script.getClass("Bob").getEnd());
		RubyClass bob = script.getClass("Bob");
		assertEquals(39, bob.getElement("initialize").getEnd());
		RubyMethod method = (RubyMethod) bob.getElement("initialize");
		assertEquals(1, method.getElementCount());
		assertTrue(method.contains(new RubyBegin(23)));
	}
	...
	public void testMethodDefaultsToPublic() throws Exception {
		...
		assertEquals(1, script.getElementCount());
		assertTrue(script.contains(new RubyModule("Bob", 7)));
		assertEquals(36, script.getModule("Bob").getEnd());
		RubyModule bob = script.getModule("Bob");
		assertEquals(1, bob.getElementCount() );
